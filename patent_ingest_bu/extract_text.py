...
def extract_text_pdftotext(pdf_path: str, raw_txt_path: str, cfg: PipelineConfig) -> dict:
    ...
    return {"command": res.args, "stderr": res.stderr, "stdout": res.stdout, "returncode": res.returncode}
